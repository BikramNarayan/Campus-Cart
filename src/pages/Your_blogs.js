  ...
  return (
    <>
      {isAuthenticated ? (
          ...
          <div className="container ride">
            {loadingProducts || loadingOrders || loadingRides ? (
              ...
              <>
                        ...
                        <div key={product.id} className="col mb-4">
                          <div className="card card1">
                            ...
                            >
                              ...
                              <p className="card-text">
                                <strong>Hostel:</strong> {product.location}
                              </p>
                              <h5 className="">
                ...
                {orders.length === 0 ? (
                  <h1 className="mt-2">
                    You don't have any Combine Orders Blog
                  </h1>
                ) : (
                  <>
                ...
                {rideData.length === 0 ? (
                  <h1 className="mt-2">You don't have any Combine Ride Blog</h1>
                ) : (
                  <>
                    <h1 className="mt-2">Your Rides</h1>
                    <div className="row row-cols-1 row-cols-md-3 g-3">
        ...
        <h1>Please Login to See Blogs</h1>
      )}
    </>
  );
};
